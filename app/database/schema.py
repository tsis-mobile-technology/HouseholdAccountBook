...
# Default templates matching Google Spreadsheet
DEFAULT_FIXED_INCOME_TEMPLATES = [
    ("기본급", "25일", "정기 급여", 4000000),
    ("상여/수당", "-", "성과급 등", 0),
    ("부수입", "-", "이자/배당 등", 0),
    ("기타", "-", "환급금 등", 0),
]
...
DEFAULT_FIXED_EXPENSE_TEMPLATES = [
    ("주거/관리비", "20일", "관리비 및 공과금", 300000),
    ("통신/인터넷", "15일", "휴대폰 및 인터넷", 120000),
    ("보장성보험", "10일", "실비 및 암보험", 250000),
    ("대출원리금", "25일", "주택담보/신용대출", 500000),
    ("구독/회비", "1일", "OTT/멤버십", 30000),
    ("기타정기지출", "-", "기타 정기출금", 0),
]

DEFAULT_SAVINGS_TEMPLATES = [
    ("정기적금/예금", "25일", "목돈 마련 적금", 1000000),
    ("연금저축/IRP", "25일", "세액공제 연금", 500000),
    ("주식/ETF투자", "25일", "적립식 투자", 500000),
    ("비상금적립", "25일", "CMA 파킹통장", 200000),
]
